// ignore_for_file: file_names, depend_on_referenced_packages, non_constant_identifier_names, avoid_print, use_build_context_synchronously
...
class DatabaseHelper {
  ...
  Future<String?> checkCartItemTypeExists(String pid, String vid) async {
    final db1 = await db;
    var result = await db1!.rawQuery("SELECT * FROM $CART_TABLE");
    if (result.isNotEmpty) {
